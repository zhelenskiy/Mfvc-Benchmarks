...
final class MyPanel extends JPanel implements KeyListener, MouseListener {
    ...
    private Point2 pos = new Point2(22.0, 12.0);
    private Vector2 dir = new Vector2(-1.0, 0.0);
    private Vector2 plane = new Vector2(0.0, 0.66);
    ...
    public void keyPressed(KeyEvent e) {
        ...
        double moveSpeed = frameTime * 0.5;
        double rotSpeed = frameTime * 0.3;
        switch (e.getKeyCode()) {
    ...
    MyPanel() {
        ...
        new Timer(1000, it -> {
            ...
            double elapsedTime = (double)(currentTime - startTime) / 1.0E9;
            fps = (double)frameCount / elapsedTime;
            if ((double)(currentTime - veryStartTime) / 1.0E9 > (double)OffsetInSeconds) {
