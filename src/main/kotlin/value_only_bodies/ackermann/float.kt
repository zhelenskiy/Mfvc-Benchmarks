package value_only_bodies.ackermann
...
operator fun ComplexFloat?.minus(other: Float) = ComplexFloat(this!!.real - other, this.imaginary)

operator fun ComplexFloat?.minus(other: ComplexFloat?) = ComplexFloat(this!!.real - other!!.real, this.imaginary - other.imaginary)

operator fun ComplexFloat?.plus(other: Float) = ComplexFloat(this!!.real + other, this.imaginary)

operator fun ComplexFloat?.plus(other: ComplexFloat?) = ComplexFloat(this!!.real + other!!.real, this.imaginary + other.imaginary)
