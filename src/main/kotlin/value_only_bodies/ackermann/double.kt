...
operator fun ComplexDouble?.minus(other: Double) = ComplexDouble(this!!.real - other, this.imaginary)

operator fun ComplexDouble?.minus(other: ComplexDouble?) =
    ComplexDouble(this!!.real - other!!.real, this.imaginary - other.imaginary)

operator fun ComplexDouble?.plus(other: Double) = ComplexDouble(this!!.real + other, this.imaginary)

operator fun ComplexDouble?.plus(other: ComplexDouble?) =
    ComplexDouble(this!!.real + other!!.real, this.imaginary + other.imaginary)
