...
operator fun ComplexLong?.minus(other: Long) = ComplexLong(this!!.real - other, this.imaginary)

operator fun ComplexLong?.minus(other: ComplexLong?) = ComplexLong(this!!.real - other!!.real, this.imaginary - other.imaginary)

operator fun ComplexLong?.plus(other: Long) = ComplexLong(this!!.real + other, this.imaginary)

operator fun ComplexLong?.plus(other: ComplexLong?) = ComplexLong(this!!.real + other!!.real, this.imaginary + other.imaginary)
